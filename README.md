...
Границы у набора выбраны, а не забыты: ниже — чего в нём нет намеренно и куда каждый пункт растёт,
когда набор переходит с тестового задания на живой продукт.
